...
public class PythonDictionaryWriter
{
    ...
    private PythonDictionaryWriter()
    {
    }

    public PythonDictionaryWriter(PythonEnumGenerator aParent)
    {
        parentClass = aParent;
    }
    ...
    public void writeOutDictionary(GeneratedEnumClasses.DictionaryElem dictionaryElement)
    {
        try {
            ...
            // sb.append(StringUtils.formatNamespaceStatement(parentClass.globalNamespace + "::dictionary", parentClass.PYTHON ));
            sb.append("\n");
            ...
            parentClass.writeOutFile(sb, classNameCorrected, parentClass.outputDirectory, classNameCorrected + ".py");
