...
import org.xml.sax.helpers.*;
  ...
  /** XML handler for recursively reading information and autogenerating code, namely an
     ...
     */
public class PythonEnumHandler extends DefaultHandler
{
    private static String       sisoSpecificationTitleDate = "";
    PythonEnumWriter enumWriter = null;
    PythonBitfieldWriter bitfieldWriter = null;
    PythonDictionaryWriter dictionaryWriter = null;

    private PythonEnumGenerator parentClass = null;

    /** default constructor */
    private PythonEnumHandler()
    {
        super();
    }

    public PythonEnumHandler(PythonEnumGenerator aParent)
    {
        this();
        parentClass = aParent;
        enumWriter = new PythonEnumWriter(aParent);
        bitfieldWriter = new PythonBitfieldWriter(aParent);
        dictionaryWriter = new PythonDictionaryWriter(aParent);
    }
